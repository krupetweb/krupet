...
<head>
	<?php
	$system_name        =	'Smarta Food Website';
	$system_title       =	'Smarta Food';
	?>
	<meta charset="utf-8">
	...
	<!--[if lt IE 9]><script src="<?php echo base_url(); ?>assets/backend/js/ie8-responsive-file-warning.js"></script><![endif]-->
...
<div class="login-container">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content" style="width:100%;">
			...
			<a href="<?php echo base_url();?>" class="logo">
				<img src="<?php echo base_url(); ?>assets/backend/images/logo.png" height="100" alt="" />
			</a>
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<div class="login-bottom-links">
				<a href="<?php echo base_url();?>login/forgot_password" class="link"><!--Forgot your password?--></a>
			</div>
	...
	<script src="<?php echo base_url(); ?>assets/backend/js/neon-login.js"></script>
