		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				<?php
						...
						$name			=$data->name;
						$banner			= base_url().$data->banner;
						$is_banner_published	= $data->is_banner_published;
						$modified_dt	=$data->modified_dt;
						
				?>
			
				<?=form_open(base_url().'admin/'.$term.'/update/'.$id , array('method'=>'POST', 'class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					<?php
