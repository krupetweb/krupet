			   ...
			   <div class="container-fluid">
					<div class="row">
						...
						<div class="col-xs-12">
								<a href="<?=base_url()?>admin/<?=$term?>/form_doctors?action=create"  class="btn btn-primary pull-right"><i class="entypo-plus-circled"></i>Add New </a> 
			   ...
			   <div class="col-xs=12">
							   ...
							   <td>
									 <div class="btn-group">
											...
											<ul class="dropdown-menu dropdown-default pull-right" role="menu">
												<li>
													<a href="<?=base_url()?>admin/<?php echo $term; ?>/form_doctors?action=update&id_doctor=<?=$row->id?>">
													<i class="entypo-pencil"></i>EDIT</a>
												</li>
												<li class="divider"></li>
												<li>
													<a target="blank" href="<?=base_url()?>en/doctors/<?=$row->slug?>">
				...
				<script type="text/javascript">
					...
					function search(){
						var url='<?php echo base_url(); ?>admin/doctors?limit='+$('#limit').val();
						if($('#from').val()!='' && $('#to').val()!=''){
