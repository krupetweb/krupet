												   ...
												   <td>
														 <div class="btn-group">
																...
																<ul class="dropdown-menu dropdown-default pull-right" role="menu">
																	<li>
																		<a href="<?=base_url()?>admin/<?=$term?>/form_hospitals?action=update&id_doctor=<?=$id_doctor?>&id_hospital=<?=$row->id?>">
																		<i class="entypo-pencil"></i>EDIT</a>
																	</li>
																	<li class="divider"></li>
																	<li>
																		<a href="#" onclick="confirm_modal('<?=base_url()?>admin/<?=$term?>/delete_hospital?id_doctor=<?=$id_doctor?>&id_hospital=<?=$row->id?>')">
