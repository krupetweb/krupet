	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
				...
				<a href="<?=base_url()?>admin/health_consultant_news"  class="btn btn-primary pull-right"><i class="entypo-back"></i>Back</a> 
            </div>
			<div class="panel-body">
				...
				<?=form_open(base_url().'admin/health_consultants/accepted' , array('method'=>'POST', 'class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					<?php
						...
						button_field(array('button_caption'=>"dalete", 'url_delete'=>base_url().'admin/health_consultants/delete_health_consultant?id='.$id));
					?>
