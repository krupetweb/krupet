						...
						<div class="col-md-12">
							<div class="panel panel-primary" data-collapsed="0">
								<div class="panel-heading">
									...
									<a href="<?=base_url()?>admin/blogs/featured"  class="btn btn-primary pull-right"><i class="entypo-back"></i>Back</a>
								</div>
								<div class="panel-body">
									...
									<?=form_open(base_url().'admin/blogs/add_featured/', array('method'=>'POST', 'class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
									<?php
