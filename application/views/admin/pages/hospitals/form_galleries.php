						...
						<div class="col-md-12">
							<div class="panel panel-primary" data-collapsed="0">
					        	<div class="panel-heading">
									...
									<a href="<?=base_url()?>admin/<?php echo $term ?>/form_galleries?action=create&id_hospital=<?=$id_hospital?>&id_gallery=0"  class="btn btn-primary pull-right"><i class="entypo-plus-circled"></i>Add New </a>
					            </div>
								<div class="panel-body">
									...
									<?=form_open(base_url().'admin/'.$term.'/'.$action.'_gallery?id_hospital='.$id_hospital.'&id_gallery='.$id , array('method'=>'POST', 'class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
									<?php 
										...
										button_field(array('button_caption'=>$button_caption, 'url_delete'=>base_url().'admin/'.$term.'/delete_gallery?id_hospital='.$id_hospital.'&id_gallery='.$id));
									?>
									<?=form_close()?>
								</div>
					        </div>
