												   ...
												   <td>
														 <div class="btn-group">
																...
																<ul class="dropdown-menu dropdown-default pull-right" role="menu">
																	<li>
																		<a href="<?=base_url()?>admin/<?=$term?>/form_specialists?action=update&id_hospital=<?=$id_hospital?>&id_specialist=<?=$row->id?>">
																		<i class="entypo-pencil"></i>EDIT</a>
																	</li>
																	<li class="divider"></li>
																	<li>
																		<a href="#" onclick="confirm_modal('<?=base_url()?>admin/<?=$term?>/delete_specialist?id_hospital=<?=$id_hospital?>&id_specialist=<?=$row->id?>')">
