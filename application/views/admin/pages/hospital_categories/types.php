							   ...
							   <td>
									<div class="btn-group">
											...
											<ul class="dropdown-menu dropdown-default pull-right" role="menu">
												<li>
													<a href="<?=base_url()?>admin/<?=$term?>/form_types?action=update&id_hospital_category=<?=$id_hospital_category?>&id_type=<?=$row->id?>">
													<i class="entypo-pencil"></i>EDIT</a>
												</li>
												<li class="divider"></li>
												<li>
													<a href="#" onclick="confirm_modal('<?=base_url()?>admin/<?=$term?>/delete_type?id_hospital_category=<?=$id_hospital_category?>&id_type=<?=$row->id?>')">
