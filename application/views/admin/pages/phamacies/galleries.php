												   ...
												   <td>
														 <div class="btn-group">
																...
																<ul class="dropdown-menu dropdown-default pull-right" role="menu">
																	<li>
																		<a href="<?=base_url()?>admin/<?=$term?>/form_galleries?action=update&id_phamacy=<?=$id_phamacy?>&id_gallery=<?=$row->id?>">
																		<i class="entypo-pencil"></i>EDIT</a>
																	</li>
																	<li class="divider"></li>
																	<li>
																		<a href="#" onclick="confirm_modal('<?=base_url()?>admin/<?=$term?>/delete_gallery?id_phamacy=<?=$id_phamacy?>&id_gallery=<?=$row->id?>')">
...
<script type="text/javascript">		
	function is_default(id_phamacy, id){
		window.location="<?php echo base_url(); ?>admin/hospitals/update_default_status_of_branches/"+id_phamacy;
	}
</script>
