<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
		 <!-- Contact Us -->
        <li class="<?php if ($active_page == 'advertisments'|| 
            ...
            <a href="#">
             ...
             <ul>
				<li class="<?php if ($active_page == 'advertisments') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>admin/advertisments">
						<span><i class="entypo-dot"></i>Advertisments</span>
					</a>
				</li>
				<li class="<?php if ($active_page == 'featured_hospitals') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>admin/featured_hospitals">
						<span><i class="entypo-dot"></i>Featured Hospitals</span>
					</a>
				</li>
				<li class="<?php if ($active_page == 'featured_doctors') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>admin/featured_doctors">
						<span><i class="entypo-dot"></i>Featured Doctors</span>
					</a>
				</li>
				 <li class="<?php if ( $active_page == 'partners'|| $active_page == 'official_sponsors' || $active_page == 'potential_partners' ) echo 'opened active has-sub'; ?> ">
		            <a href="#">
		                <i class="entypo-dot"></i>
		                <span>Partners</span>
		            </a>
		            <ul>
						<li class="<?php if ($active_page == 'potential_partners') echo 'active'; ?> ">
							<a href="<?php echo base_url(); ?>admin/partners/1">
								<span><i class="entypo-dot"></i>Potential Partners</span>
							</a>
						</li>
						<li class="<?php if ($active_page == 'official_sponsors') echo 'active'; ?> ">
							<a href="<?php echo base_url(); ?>admin/partners/2">
								<span><i class="entypo-dot"></i>Official Sponsors</span>
							</a>
						</li>
		...
		<li class="<?php if ($active_page == 'phamacies') echo 'active';?>">
		 ...
		 <li class="<?php if ( $active_page == 'special_blog' || $active_page == 'featured_blog' || $active_page == 'tips'|| $active_page == 'news' ) echo 'opened active has-sub'; ?> ">
            <a href="#">
                <i class="fa fa-book"></i>
                <span>Blogs</span>
            </a>
            <ul>
            	<li class="<?php if ($active_page == 'special_blog') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>admin/special_blog">
						<span><i class="entypo-dot"></i>Speacial Aticles</span>
					</a>
				</li>

            	<li class="<?php if ($active_page == 'featured_blog') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>admin/featured_blog">
						<span><i class="entypo-dot"></i>Featured Aticle </span>
					</a>
				</li>
				<li class="<?php if ($active_page == 'tips') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>admin/blogs/1">
						<span><i class="entypo-dot"></i>Tips</span>
					</a>
				</li>
				<li class="<?php if ($active_page == 'news') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>admin/blogs/2">
						<span><i class="entypo-dot"></i>News</span>
					</a>
				</li>
        ...
        <li class="<?php if ($active_page == 'feedback') echo 'active';?>">
		...
		<li class="<?php if ($active_page == 'health_consultants' ||$active_page == 'health_consultant_accepteds'|| $active_page == 'health_consultant_news'|| $active_page == 'contact_information'|| $active_page == 'contents' || $active_page == 'contact_email'  ) echo 'opened active has-sub'; ?> ">
            <a href="#">
             ...
             <ul>
				...
				<li class="<?php if ($active_page == 'health_consultant_news') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>admin/health_consultant_news">
						<span><i class="entypo-dot"></i>New Requsts</span>
					</a>
				</li>
				<li class="<?php if ($active_page == 'health_consultant_accepteds') echo 'active'; ?> ">
					<a href="<?php echo base_url(); ?>admin/health_consultant_accepteds">
            ...
            <a href="#">
             ...
             <ul>
				...
				<li class="<?php if ($active_page == 'feedback_questions') echo 'active'; ?> ">
				 ...
				 <li class="<?php if ( $active_page == 'services'|| $active_page == 'service_categories' ) echo 'opened active has-sub'; ?> ">
		            <a href="#">
		                <i class="entypo-dot"></i>
		                <span>Service</span>
		            </a>
		            <ul>
						...
						<li class="<?php if ($active_page == 'service_categories') echo 'active'; ?> ">
							<a href="<?php echo base_url(); ?>admin/service_categories">
