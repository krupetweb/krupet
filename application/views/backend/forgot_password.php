            ...
            <div class="login-header login-caret">
                ...
                <div class="login-content" style="width:100%;">
                    ...
                    <a href="<?php echo base_url(); ?>" class="logo">
						<img src="<?php echo base_url(); ?>assets/backend/images/logo.png" height="60" alt="" />
                    </a>
                ...
                <div class="login-content">
                    ...
                    <form method="post" role="form" id="form_forgot_password">
                        ...
                        <div class="form-steps">
                            ...
                            <div class="step current" id="step-1">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-info btn-block btn-login">Reset password <i class="entypo-right-open-mini"></i>
                                    </button>
                                </div>
                    ...
                    <div class="login-bottom-links">
                        ...
                        <a href="<?php echo base_url(); ?>index.php?login" class="link">
                            <i class="entypo-lock"></i>Return to log in page </a>
