				<a href="<?=base_url()?>admin/special_blog_form/create"  class="btn btn-primary pull-right"><i class="entypo-plus-circled"></i>Add New </a> 
			   <br><br>
                ...
                <?php $page_name="blogs"; include('data_order.php');?>
