								 ...
								 <td>
									 <div class="btn-group">
											...
											<ul class="dropdown-menu dropdown-default pull-right" role="menu">
												<li>
													<a href="<?php base_url()?>health_consultant_form/<?php echo $row->id?>">
													<i class="entypo-pencil"></i>EDIT</a>
												</li>
												<li class="divider"></li>
												<li>
													<a href="<?=base_url()?>admin/update_acepted/<?=$row->id?>">
													<i class="entypo-trash"></i>Accepted</a>
												</li>
												<li class="divider"></li>
												<li>
													<a href="#" onclick="confirm_modal('<?=base_url()?>admin/deleted_health_consultant_news/delete/<?=$row->id?>')">
