				<a href="<?=base_url()?>admin/featured_hospital_form/create"  class="btn btn-primary pull-right"><i class="entypo-plus-circled"></i>Add New </a> 
								...
								<td>
									 <div class="btn-group">
											...
											<ul class="dropdown-menu dropdown-default pull-right" role="menu">
												...
												<li>
													<a href="<?=base_url()?>admin/remove_featured_hospital/<?=$row->id?>">
