	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
				...
				<a href="<?=base_url()?>admin/hospital_survey_categories"  class="btn btn-primary pull-right"><i class="entypo-back"></i>Back</a> 
            </div>
			<div class="panel-body">
				...
				<?=form_open(base_url().'admin/hospital_survey_category_cud/'.$action.'/'.$id , array('method'=>'POST', 'class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
				<?php 
					...
					button_field(array('button_caption'=>$button_caption, 'url_delete'=>base_url().'admin/hospital_survey_category_cud/delete/'.$id));
				?>
				<?=form_close()?>
			</div>
        </div>
