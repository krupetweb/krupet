						...
						<tr>
							<td align="center">
								<table class="col2" width="262" border="0" align="right" cellpadding="0" cellspacing="0">
									<tr>
										<td align="center" style="line-height:0px;">
											<a href="<?php echo base_url();?>en/<?php echo $go;?>/<?php echo $row->slug; ?>">
									...
									<tr>
										<td align="center">
											<table class="insider" width="308" border="0" align="left" cellpadding="0" cellspacing="0">
												<tr align="left">
													<td style="font-family:HelveticaNeueBold,Helvetica,Arial,sans-serif; font-size:21px; color:#D12026; line-height:30px;"><a href="<?php echo base_url();?>en/<?php echo $go;?>/<?php echo $row->slug; ?>" target="_blank" style="color:#D12026;text-decoration:none"><?php echo $row->en_title ?></a></td>
												</tr>
												...
												<tr>
													<td style="font-family:HelveticaNeue-Medium,Helvetica,Arial,sans-serif; font-size:18px; color:#757575; line-height:24px;">
														<?php echo $row->en_pre_content ?>
														<a href="<?php echo base_url();?>en/<?php echo $go;?>/<?php echo $row->slug; ?>" target="_blank" style="color:#D12026;text-decoration:none">More &gt;&gt;</span>
													</td>
												</tr>
											</table>
										</td>
