					                                ...
					                                <td>
						                                <div class="btn-group" >
						                                    ...
						                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
						                                        <li>
						                                        	<a href="<?=base_url()?>admin/vertical_ads_displays_form/update/<?=$id_page?>/<?=$row->id?>" >
						                                            <i class="entypo-pencil"></i>EDIT</a>
						                                        </li>
						                                        <li class="divider"></li>
						                                        <li>
						                                        	<a href="#" onclick="confirm_modal('<?=base_url()?>admin/vertical_ads_displays_cud/delete/<?=$id_page?>/<?=$row->id?>')">
