						...
						<div class="col-md-12">
							<div class="panel panel-primary" data-collapsed="0">
								...
								<div class="panel-body">
									...
									<?=form_open(base_url().'admin/doctor_specialist_cud/'.$action.'/'.$id_doctor.'/'.$id , array('method'=>'POST', 'class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
									<?php
										select_field(array('caption'=>'Specialists', 'name'=>'id_specialist', 'data'=>$specialists_data, 'id'=>$id_specialist));
										button_field(array('button_caption'=>$button_caption, 'url_delete'=>base_url().'admin/doctor_specialist_cud/delete/'.$id_doctor.'/'.$id));
									?>
									<?=form_close()?>
								</div>
							</div>
