									...
									<div id="form" class="form-horizontal"> 
										...
										<div class="form-group">
											<div class="col-sm-offset-2 col-sm-10">
											  ...
											  <button id="btn-action"  onclick="generate_hospital_codes(<?php echo $id_hospital?>)" class="btn btn-primary"><i class="entypo-plus-circled"></i> Generate</button>
											</div>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
	function generate_hospital_codes(id_hospital){
		...
		//::::::::::::::::::::::::::::::::::::::::::::>> Start to add Data
		$.ajax({
		  url: "<?php echo base_url() ?>admin/generate_hospital_codes",
		  method:"POST",
